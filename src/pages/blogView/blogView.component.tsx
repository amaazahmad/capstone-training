...
const BlogView = () => {
     ...
     return (
          ...
          <div className={`h-screen w-screen bottom-0 flex flex-col box-border pb-12 pt-12 xl:flex-row xl:pt-16 xl:overflow-scroll ${theme ? " bg-dark-gray-text-color" : ""}`}>
               ...
               {loaderVisible ? <Bars visible={loaderVisible} height="100" width="100" color="rgba(86, 204, 106, 1)" wrapperStyle={{ alignSelf: 'center', justifySelf: 'center', paddingTop: "40px" }} /> : <div className={`w-full pl-11 pr-11 flex flex-col items-start mt-2 pb-4 xl:p-0 xl:mt-0 xl:mb-10 xl:h-full xl:w-[70%] ${theme ? " bg-dark-gray-text-color" : ""}`}>
